  ...
  <section class="row" ng-show="wallet!=null" ng-controller='viewWalletCtrl'>
    ...
    <div class="col-sm-6">
      ...
      <p class="text-primary">
        <strong style="margin-left: 1em"> {{etherBalance}} Krypton </strong>
        <br />
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p> If you want to use this wallet with your MyKryptonWallet CX in the future, you will need to manually re-add it using the private key/JSON and password.</p>
