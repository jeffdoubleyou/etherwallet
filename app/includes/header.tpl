...
@@if (site === 'cx' ) {
  ...
  <header class="container-fluid bg-gradient text-white">
    <section class="container">
      <a href="/cx-wallet.html"><img src="images/etherwalletcx-logo.png" height="70px" width="auto" alt="My Krypton Wallet" /></a>
      <p>Open Source JavaScript Client-Side Krypton Wallet Chrome Extension &middot; v2.9</p>
    </section>
  </header>
}
